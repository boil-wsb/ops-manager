...
class Deployment(BaseModel):
    ...
    # People
    deployer_id: Mapped[Optional[int]] = mapped_column(
    ...
    # Timing
    deploy_time: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
...
class Certificate(BaseModel):
    ...
    cert_content: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class DNSRecord(BaseModel):
    ...
    priority: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)  # For MX records
    
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    
    # Provider info
    provider: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    provider_record_id: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
