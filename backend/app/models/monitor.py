...
class Monitor(BaseModel):
    ...
    http_headers: Mapped[Optional[Dict[str, str]]] = mapped_column(JSON, nullable=True)
    ...
    expected_response_content: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    last_check_result: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    last_check_duration_ms: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
