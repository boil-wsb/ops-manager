...
async def list_audit_logs(
    ...
    operation_type: Optional[str] = Query(None, description="操作类型: LOGIN, LOGOUT, CREATE, UPDATE, DELETE, EXPORT"),
    operation_module: Optional[str] = Query(None, description="模块: asset, user, role, monitor, certificate, deploy, system"),
