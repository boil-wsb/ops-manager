...
class AuditLogBase(BaseModel):
    ...
    operation_type: str = Field(
        ..., max_length=50, description="操作类型: LOGIN, LOGOUT, CREATE, UPDATE, DELETE, EXPORT"
    )
    operation_module: str = Field(
        ...,
        max_length=50,
        description="模块: asset, user, role, monitor, certificate, deploy, system",
    )
